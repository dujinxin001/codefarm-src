 ...
 *******************************************************************************/
package com.sxj.spring.modules.test.selenium;
...
public class Selenium2
{
    ...
    {
        final String urlToOpen = url.indexOf("://") == -1 ? baseUrl
    ...
    {
        waitForCondition(ExpectedConditions.titleContains(title),
                DEFAULT_WAIT_TIME);
    }
    ...
    {
        waitForCondition(ExpectedConditions.textToBePresentInElementValue(by,
                value), DEFAULT_WAIT_TIME);
    }
    ...
    {
        return table.findElement(By.xpath("//tr[" + (rowIndex + 1) + "]//td["
