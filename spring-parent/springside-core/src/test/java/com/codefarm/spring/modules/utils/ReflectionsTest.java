...
public class ReflectionsTest
{
    ...
    public void getAndSetFieldValue()
    {
        ...
        assertThat(Reflections.getFieldValue(bean, "privateField"))
                .isEqualTo(1);
    ...
    {
        TestBean bean = new TestBean();
        assertThat(Reflections.invokeGetter(bean, "publicField"))
                .isEqualTo(bean.inspectPublicField() + 1);
    ...
    public void invokeMethod()
    {
        TestBean bean = new TestBean();
        // 使用函数名+参数类型的匹配
        assertThat(Reflections.invokeMethod(bean,
                "privateMethod",
                new Class[] { String.class },
                new Object[] { "calvin" })).isEqualTo("hello calvin");
        
        // 仅匹配函数名
        assertThat(Reflections.invokeMethodByName(bean,
                "privateMethod",
                new Object[] { "calvin" })).isEqualTo("hello calvin");
        ...
        try
        {
            Reflections.invokeMethodByName(bean,
                    "notExistMethod",
                    new Object[] { "calvin" });
            failBecauseExceptionWasNotThrown(IllegalArgumentException.class);
        }
    ...
    {
        // 获取第1，2个泛型类型
        assertThat(Reflections.getClassGenricType(TestBean.class))
                .isEqualTo(String.class);
        assertThat(Reflections.getClassGenricType(TestBean.class, 1))
        ...
        // 无父类定义
        assertThat(Reflections.getClassGenricType(TestBean3.class))
                .isEqualTo(Object.class);
    }
    ...
    public void convertReflectionExceptionToUnchecked()
    {
        ...
        RuntimeException e = Reflections
        ...
        e = Reflections.convertReflectionExceptionToUnchecked(
