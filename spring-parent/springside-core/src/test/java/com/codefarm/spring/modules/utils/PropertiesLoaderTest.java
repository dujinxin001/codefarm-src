...
import com.codefarm.spring.modules.util.PropertiesLoader;
...
public class PropertiesLoaderTest
{
    ...
    {
        Properties p = new PropertiesLoader("classpath:/test1.properties",
                "classpath:/test2.properties").getProperties();
    ...
    public void notExistProperty() throws IOException
    {
        ...
        assertThat(pl.getProperty("notexist", "defaultValue"))
    ...
    {
        PropertiesLoader pl = new PropertiesLoader(
                "classpath:/test1.properties", "classpath:/test2.properties");
        ...
        assertThat(pl.getBoolean("notExist", true))
