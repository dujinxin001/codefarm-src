 ...
 *******************************************************************************/
package com.codefarm.spring.modules.beanvalidator;
...
import com.codefarm.spring.modules.beanvalidator.BeanValidators;
...
public class BeanValidatorsTest extends SpringContextTestCase
{
    ...
    public void validateWithException()
    {
        ...
        catch (ConstraintViolationException e)
        {
            ...
            assertThat(mapResult).contains(entry("email",
                    "not a well-formed email address"),
                    entry("name", "may not be empty"));
        }
    }
