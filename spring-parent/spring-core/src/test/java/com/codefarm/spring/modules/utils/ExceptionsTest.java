...
public class ExceptionsTest
{
    ...
    public void unchecked()
    {
        ...
        RuntimeException runtimeException2 = Exceptions
    ...
    public void isCausedBy()
    {
        ...
        assertThat(Exceptions.isCausedBy(runtimeException, IOException.class))
                .isTrue();
        assertThat(Exceptions.isCausedBy(runtimeException,
                IllegalStateException.class,
                IOException.class)).isTrue();
        assertThat(Exceptions.isCausedBy(runtimeException, Exception.class))
                .isTrue();
        assertThat(Exceptions.isCausedBy(runtimeException,
