package com.sxj.spring.modules.quartz;
        ...
        FactoryBean<JobDetail>, BeanNameAware, InitializingBean
{
    ...
    public static class MethodInvokingJob implements Job
    {
                ...
                throws JobExecutionException
        {
            ...
            {
                logger.debug("start");
                String targetClass = context.getMergedJobDataMap()
                        .getString("targetClass");
                ...
                Object targetObject = context.getMergedJobDataMap()
                        .get("targetObject");
                logger.debug("targetObject is " + targetObject);
                String targetMethod = context.getMergedJobDataMap()
                        .getString("targetMethod");
                logger.debug("targetMethod is " + targetMethod);
                String staticMethod = context.getMergedJobDataMap()
                        .getString("staticMethod");
