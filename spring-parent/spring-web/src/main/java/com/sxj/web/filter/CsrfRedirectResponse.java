...
public class CsrfRedirectResponse extends HttpServletResponseWrapper
{
    ...
    public CsrfRedirectResponse(HttpServletResponse response,
            HttpServletRequest request, CsrfGuard csrfGuard)
    {
        super(response);
    ...
    public void sendRedirect(String location) throws IOException
    {
        ...
        if (!sanitizedLocation.contains("://")
                && csrfGuard.isProtectedPageAndMethod(sanitizedLocation, "GET"))
        {
            /** update tokens **/
