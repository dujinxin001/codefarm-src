package com.codefarm.redis.provider.impl;
...
import com.codefarm.redis.provider.exception.RedisException;
...
public class SingleRedisProvider implements RProvider
{
    ...
    public void initRedisProvider()
    {
        try
        {
            InputStream configStream = ClassLoaderUtil
        ...
        {
            throw new RedisException("Unabled to initialize cache providers",
                    e);
        }
    }
