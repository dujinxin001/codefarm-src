package com.sxj.mybatis.shard.spring.ns;
...
public class ShardTxAdviceBeanDefinitionParser extends
        AbstractSingleBeanDefinitionParser
{
            ...
            BeanDefinitionBuilder builder)
    {
        ...
        List<Element> txAttributes = DomUtils.getChildElementsByTagName(element,
                ATTRIBUTES_ELEMENT);
    ...
    private RootBeanDefinition parseAttributeSource(Element attrEle,
            ParserContext parserContext)
    {
        ...
        for (Element methodEle : methods)
        {
            ...
            {
                attribute.setIsolationLevelName(RuleBasedTransactionAttribute.PREFIX_ISOLATION
                        + isolation);
            }
        ...
        attributeSourceDefinition.getPropertyValues().add("nameMap",
                transactionAttributeMap);
            ...
            List<RollbackRuleAttribute> rollbackRules, String rollbackForValue)
    {
        ...
        {
            rollbackRules.add(new RollbackRuleAttribute(
            ...
            List<RollbackRuleAttribute> rollbackRules, String noRollbackForValue)
    {
        ...
        for (String typeName : exceptionTypeNames)
        {
            rollbackRules.add(new NoRollbackRuleAttribute(
                    StringUtils.trimWhitespace(typeName)));
        }
    }
}
