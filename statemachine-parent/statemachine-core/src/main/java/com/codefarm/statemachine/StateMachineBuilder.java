...
import com.codefarm.statemachine.strategy.NonReentrantStrategy;
import com.codefarm.statemachine.strategy.ReentrantStrategy;
...
public class StateMachineBuilder<S extends Enum<?>>
{
            ...
            Object instance) throws StateMachineException
    {
        ...
        if (!clazz.isAnnotationPresent(com.codefarm.statemachine.annotations.StateMachine.class))
        {
