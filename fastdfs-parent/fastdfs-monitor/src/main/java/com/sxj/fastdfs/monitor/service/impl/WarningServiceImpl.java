...
public class WarningServiceImpl extends BaseService implements WarningService
{
    ...
    public void updateWarning(WarningData wd) throws IOException
    {
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public List<WarningData> findWarning() throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public List<WarningData> findWarning(WarningData wd, PageInfo pageInfo)
            throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
        List<WarningData> warningDatas = new ArrayList<WarningData>();
        ...
        if (!StringUtils.isEmpty(wd.getWdIpAddr()))
        {
        ...
        query.setFirstResult((pageInfo.getPageNum() - 1)
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public WarningData findById(String id) throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public void delWarning(String id) throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
        WarningData wd = new WarningData();
        wd.setId(id);
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public List<WarningData> findByIp(String ip) throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
        List<WarningData> warningDatas = new ArrayList<WarningData>();
        Session session = getSession();
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public List<WarningUser> findWarUser() throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public List<WarningUser> findWarUser(WarningUser wu, PageInfo pageInfo)
            throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
        List<WarningUser> warningUsers = new ArrayList<WarningUser>();
        Session session = getSession();
        StringBuilder queryString = new StringBuilder("from WarningUser as w ");
        if (!StringUtils.isEmpty(wu.getName()))
        {
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public WarningUser findUserId(String id) throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public void delWarUser(String id) throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
        WarningUser wu = new WarningUser();
        wu.setId(id);
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public void updateWarUser(WarningUser wu) throws IOException
    {
        //To change body of implemented methods use File | Settings | File Templates.
        Session session = getSession();
