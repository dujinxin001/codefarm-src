package com.codefarm.fastdfs.monitor.util;
...
public class Tools
{
    ...
    public static List<String> exeRemoteConsole(String hostname,
    ...
    {
        String classPath = Tools.class.getClassLoader()
                .getResource("/")
                .getPath();
        String rootPath = "";
        //windows下
    ...
    static
    {
        ...
        try
        {
            ...
            Document document = saxReader.read(Tools.getClassPath()
                    + "config.xml");
            ...
            for (Element element : elements)
            {
                ...
                if (element.element("ssh") != null)
                {
                    ...
                    int port = Integer.parseInt(element.element("port")
                            .getText());
    ...
    {
        Tools.exeRemoteConsole("192.168.1.13",
                "root",
                "dfs13centos",
                "ps aux|grep fdfs");
    }
