...
import com.codefarm.fastdfs.monitor.vo.Message;
...
public class WarningAction
{
    ...
    public ModelAndView warningValue(String wdIpAddr, PageInfo pageInfo)
            throws IOException
    {
        ModelAndView mv = new ModelAndView("warning/warningValue.jsp");
        WarningData wd = new WarningData();
        wd.setWdIpAddr(wdIpAddr);
        List<WarningData> warningDataLists = warningService.findWarning(wd,
                pageInfo);
    ...
    public ModelAndView warningEdit(String id) throws IOException
    {
    ...
    public Message saveWarning(String warningdataid, String ips,
            String wdFreeMB, String wdCpu, String wdMem) throws Exception
    {
        ...
        WarningData wd = new WarningData();
        if (!StringUtils.isEmpty(warningdataid))
        {
    ...
    public Message delWarning(String ids) throws IOException
    {
        Message message = null;
        String[] id = ids.split(",");
        for (String i : id)
    ...
    public List<Message> selectIp() throws Exception
    {
    ...
    public ModelAndView warUserList(String wusername, PageInfo pageInfo)
            throws IOException
    {
        ModelAndView mv = new ModelAndView("warning/warUserList.jsp");
        WarningUser wu = new WarningUser();
        wu.setName(wusername);
        List<WarningUser> warningUserList = warningService.findWarUser(wu,
                pageInfo);
    ...
    public ModelAndView warUserAdd(String id) throws IOException
    {
    ...
    public Message delWarUser(String ids) throws IOException
    {
        Message message = null;
        String[] id = ids.split(",");
        for (String i : id)
    ...
    public Message saveWarUser(String wuid, String wuname, String wuphone,
            String wuemail) throws IOException
    {
        Message message = null;
