...
public class JsshProxy
{
    ...
    public JsshProxy(String ip, String username, int port, String dsaPath)
    ...
    public CommandMessage updateFile(FileType type, File shellFile)
    {
        ...
        if (shellFile != null && shellFile.canRead() && shellFile.isFile())
        {
            try
            {
                ...
                //				}
                c.put(shellFile.getAbsolutePath(),
                        distpath + shellFile.getName(),
    ...
    public CommandMessage updatePasswd(String newPasswd)
    {
        ...
        if (authType == 1)
        {
            cm = executeCommand("echo " + username + ":" + passwd
                    + " | chpasswd", null);
