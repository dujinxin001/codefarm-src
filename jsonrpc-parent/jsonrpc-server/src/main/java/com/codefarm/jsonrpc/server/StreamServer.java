...
import com.codefarm.jsonrpc.core.exception.StreamEndedException;
...
public class StreamServer
{
     ...
     */
    public StreamServer(JsonRpcServer jsonRpcServer, int maxThreads,
            ServerSocket serverSocket)
    {
        ...
        executor = new ThreadPoolExecutor(maxThreads + 1, maxThreads + 1, 0L,
     ...
     */
    public StreamServer(JsonRpcServer jsonRpcServer, int maxThreads, int port,
    ...
    public void start()
    {
        ...
        LOGGER.log(Level.INFO,
                "StreamServer starting " + serverSocket.getInetAddress() + ":"
    ...
    public void stop() throws InterruptedException
    {
        ...
        try
        {
            ...
            {
                executor.awaitTermination(2000 + SERVER_SOCKET_SO_TIMEOUT,
        ...
        catch (InterruptedException e)
        {
            LOGGER.log(Level.SEVERE,
                    "InterruptedException while waiting for termination",
                    e);
            throw e;
        }
    }
