...
import com.codefarm.jsonrpc.core.DefaultExceptionResolver;
import com.codefarm.jsonrpc.core.ExceptionResolver;
import com.codefarm.jsonrpc.core.NoCloseOutputStream;
import com.codefarm.jsonrpc.core.ReadContext;
import com.codefarm.jsonrpc.core.exception.JsonRpcClientException;
...
public class JsonRpcClient
{
    ...
    /**
     * Creates a client that uses the given {@link ObjectMapper} to map to and
     * from JSON and Java objects.
     * 
     * @param mapper
    ...
    /**
     * Creates a client that uses the default {@link ObjectMapper} to map to and
     * from JSON and Java objects.
     */
    ...
    /**
     * Invokes the given method on the remote service passing the given
     * arguments, a generated id and reads a response.
     * 
     ...
     *             on error
     */
    public Object invokeAndReadResponse(String methodName, Object argument,
            Type returnType, OutputStream ops, InputStream ips)
            throws Throwable
    {
        return invokeAndReadResponse(methodName,
                argument,
                returnType,
                ops,
                ips,
    ...
    public <T> T invokeAndReadResponse(String methodName, Object argument,
            Class<T> clazz, OutputStream ops, InputStream ips) throws Throwable
    {
        return (T) invokeAndReadResponse(methodName,
                argument,
                Type.class.cast(clazz),
                ops,
                ips);
    }
    ...
    /**
     * Invokes the given method on the remote service passing the given
     * arguments and reads a response.
     * 
     * @see #writeRequest(String, Object, OutputStream, String)
     * @param methodName
     *            the method to invoke
     ...
     */
    public Object invokeAndReadResponse(String methodName, Object argument,
            Type returnType, OutputStream ops, InputStream ips, String id)
            throws Throwable
    {
    ...
    @SuppressWarnings("unchecked")
    public <T> T invokeAndReadResponse(String methodName, Object argument,
            Class<T> clazz, OutputStream ops, InputStream ips, String id)
            throws Throwable
    {
        return (T) invokeAndReadResponse(methodName,
                argument,
    ...
    /**
     * Invokes the given method on the remote service passing the given
     * argument. An id is generated automatically. To read the response
     * {@link #readResponse(Type, InputStream)} must be subsequently called.
     * 
     * @see #writeRequest(String, Object, OutputStream, String)
     * @param methodName
     *            the method to invoke
     ...
     *             on error
     */
    public void invoke(String methodName, Object argument, OutputStream ops)
            throws IOException
    {
        try
        {
    ...
    /**
     * Invokes the given method on the remote service passing the given
     * argument. To read the response {@link #readResponse(Type, InputStream)}
     * must be subsequently called.
     * 
     * @see #writeRequest(String, Object, OutputStream, String)
     * @param methodName
     *            the method to invoke
     ...
     * without reading or expecting a return response.
     * 
     * @see #writeRequest(String, Object, OutputStream, String)
     * @param methodName
     *            the method to invoke
     ...
     *             on error
     */
    public void invokeNotification(String methodName, Object argument,
        ...
        try
        {
            ...
            if (LOGGER.isLoggable(Level.FINE))
            {
                LOGGER.log(Level.FINE,
                        "JSON-PRC Response: " + response.toString());
            }
    ...
    /**
     * Writes a JSON-RPC request to the given {@link OutputStream}. If the value
     * passed for argument is null then the {@code params} property is ommitted
     * from the JSON-RPC request. If the argument is not not null then it is
     * used as the value of the {@code params} property. This means that if a
     * POJO is passed as the argument that it's properties will be used as the
     * param, ie:
     * 
     * <pre>
     * class Person {
     ...
     * {@code firstName} and {@link lastName}. If the argument passed in
     * implements the {@link Collection} interface or is an array then the
     * values are used as indexed parameters in the order that they appear in
     * the {@link Collection} or array.
     * 
     * @param methodName
     *            the method to invoke
     * @param argument
     ...
     *             on error
     */
    public void writeRequest(String methodName, Object argument,
            OutputStream ops, String id) throws IOException
    {
        internalWriteRequest(methodName, argument, ops, id);
    }
    
    /**
     * Writes a JSON-RPC notification to the given {@link OutputStream}.
     * 
     * @see #writeRequest(String, Object, OutputStream, String)
     * @param methodName
     *            the method to invoke
     ...
     *             on error
     */
    public void writeNotification(String methodName, Object argument,
            OutputStream ops) throws IOException
    {
     ...
     *             on error
     */
    private void internalWriteRequest(String methodName, Object arguments,
            OutputStream ops, String id) throws IOException
    {
    ...
    /**
     * Writes and flushes a value to the given {@link OutputStream} and prevents
     * Jackson from closing it.
     * 
     * @param ops
     ...
     *             on error
     */
    private void writeAndFlushValue(OutputStream ops, ObjectNode value)
            throws IOException
    {
    ...
    /**
     * Returns the {@link ObjectMapper} that the client is using for JSON
     * marshalling.
     * 
    ...
    /**
     * Provides access to the jackson {@link ObjectNode}s that represent the
    ...
    public interface RequestListener
    {
         ...
         * Modifications can be made to the request before it's sent.
         * 
         * @param client
         *            the {@link JsonRpcClient}
         * @param request
         *            the request {@link ObjectNode}
         */
        void onBeforeRequestSent(JsonRpcClient client, ObjectNode request);
        
        /**
         * Called after a response has been returned and successfully parsed but
         * before it has been processed and turned into java objects.
         * 
         * @param client
         *            the {@link JsonRpcClient}
         * @param response
         *            the response {@link ObjectNode}
         */
