...
import com.codefarm.jsonrpc.core.exception.HttpException;
...
public class JsonRpcHttpClient extends JsonRpcClient
{
    ...
    /**
     * Creates the {@link JsonRpcHttpClient} bound to the given
     ...
     *            the headers
     */
    public JsonRpcHttpClient(ObjectMapper mapper, URL serviceUrl,
     ...
     * 
     * @see JsonRpcClient#writeRequest(String, Object, java.io.OutputStream,
     *      String)
     * @param methodName
    ...
    /**
     * Invokes the given method with the given arguments and returns an object
     * of the given type, or null if void.
     * 
     * @see JsonRpcClient#writeRequest(String, Object, java.io.OutputStream,
     *      String)
     * @param methodName
            ...
            Map<String, String> extraHeaders) throws Throwable
    {
        ...
        try
        {
            ...
            try
            {
                // in case of http error try to read response body and return it
                // in exception
            ...
            Map<String, String> extraHeaders) throws IOException
    {
        ...
        con.setRequestProperty("file.encoding", "UTF-8");
