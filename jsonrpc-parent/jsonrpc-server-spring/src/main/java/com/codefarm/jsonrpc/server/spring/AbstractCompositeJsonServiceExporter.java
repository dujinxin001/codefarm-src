...
import com.codefarm.jsonrpc.core.ProxyUtil;
import com.codefarm.jsonrpc.server.JsonRpcServer;
 ...
 *
 */
public abstract class AbstractCompositeJsonServiceExporter implements
        InitializingBean, ApplicationContextAware
{
    ...
    public final void afterPropertiesSet() throws Exception
    {
        ...
        // create the service
        Object service = ProxyUtil.createCompositeServiceProxy(getClass().getClassLoader(),
                services,
                serviceInterfaces,
