...
public class ToHtml
{
     ...
     */
    public static ToHtml create(Workbook wb, OutputStream output)
    {
     ...
     * @return An object for converting the workbook to HTML.
     */
    //    public static ToHtml create(InputStream source, OutputStream output)
    //            throws IOException
    //    {
    ...
    private ToHtml(Workbook wb, OutputStream output)
    {
        if (wb == null)
    ...
    private void ensureOut()
    {
        ...
        {
            if (out == null)
                out = new Formatter(output, "UTF-8");
        }
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        ToHtml toHtml = create(
                new FileInputStream(
                        new File("D:\\scm-repository\\git\\sxj\\abc.xlsx")),
                new FileOutputStream(new File(
                        "D:\\scm-repository\\git\\sxj\\abc.xlsx.html")));
