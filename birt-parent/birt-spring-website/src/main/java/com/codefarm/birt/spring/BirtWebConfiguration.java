...
public class BirtWebConfiguration extends WebMvcConfigurerAdapter
{
    ...
    {
        registry.addViewController("/reports/*.rpt");
        registry.addViewController("/reports/*.xls");
        registry.addViewController("/reports/*.pdf");
    ...
    @Bean
    // this should always be #2 in the resolution chain!
    public BirtViewResolver rptViewResolver() throws Exception
    {
    ...
    //        abstractSingleFormatBirtView
    //                .setDataSource(birtDataServiceConfiguration.dataSource());
