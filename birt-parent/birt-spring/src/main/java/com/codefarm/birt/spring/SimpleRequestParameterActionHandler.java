...
public class SimpleRequestParameterActionHandler implements IHTMLActionHandler
{
    ...
    public SimpleRequestParameterActionHandler(String reportNameKey,
            String formatKey)
    {
        ...
        {
            public String urlForAction(int actionType, IAction actionDefn,
                    IReportContext ctx) throws Exception
            {
    ...
    public String getURL(IAction actionDefn, IReportContext context)
    {
        try
        {
            return (actionDefn != null && urlBuilderMap.containsKey(actionDefn.getType())) ? urlBuilderMap.get(actionDefn.getType())
                    .urlForAction(actionDefn.getType(), actionDefn, context)
                    : null;
        }
        catch (Exception e)
        {
    ...
    {
        String urlForAction(int actionType, IAction actionDefn,
                IReportContext ctx) throws Exception;
    }
